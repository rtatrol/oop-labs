package minesweeper.java.Minesweeper.config;

import minesweeper.java.Minesweeper.exception.config.ConfigurationException;
...
public class Configuration {
    ...
    public void setMinesNumber(int minesNumber) throws ConfigurationException {
        if (minesNumber < 0 || minesNumber >= lineLength * columnLength) 
            throw new ConfigurationException("wrong mines number");
